#!/usr/bin/env python3
"""Rebrand site to Marblehead Maids and update MA location references."""
...
REPLACEMENTS = [
    ("Marblehead Maids", "Marblehead Maids"),
    ("Madtown <span class=\"text-primary\">Maids</span>", "Marblehead <span class=\"text-primary\">Maids</span>"),
    ("Madtown <span class=\"text-primary\">Maids</span>", "Marblehead <span class=\"text-primary\">Maids</span>"),
    ("marbleheadmaids.com", "marbleheadmaids.com"),
    ("Marblehead Maids - Clone Styles", "Marblehead Maids - Styles"),
    ...
    ("Why the North Shore Trusts Marblehead Maids", "Why the North Shore Trusts Marblehead Maids"),
    ...
    ("Marblehead Maids was built on the North Shore, for Madison", "Marblehead Maids was built on the North Shore, for the North Shore"),
    ...
    ("Careers at Marblehead Maids — Join Our Cleaning Team in North Shore, MA", "Careers at Marblehead Maids — Join Our Cleaning Team on the North Shore, MA"),
    ("Join the Marblehead Maids team! We're hiring reliable, detail-oriented cleaners in the North Shore and North Suburbs, MA.", "Join the Marblehead Maids team! We're hiring reliable, detail-oriented cleaners on the North Shore and North Suburbs, MA."),
    ("About Marblehead Maids", "About Marblehead Maids"),
    ("About Marblehead Maids — Locally Owned Cleaning Company in North Shore, MA", "About Marblehead Maids — Locally Owned Cleaning Company on the North Shore, MA"),
    ("A North Shore cleaning company built on trust", "A North Shore cleaning company built on trust"),
    ("Why We Started Marblehead Maids", "Why We Started Marblehead Maids"),
    ("Join the Marblehead Maids Team", "Join the Marblehead Maids Team"),
    ("Contact Marblehead Maids", "Contact Marblehead Maids"),
    ("Marblehead Maids is a locally owned cleaning company based in Marblehead, Massachusetts", "Marblehead Maids is a locally owned cleaning company based in Marblehead, Massachusetts"),
    ("Marblehead Maids is a locally owned cleaning company based on the North Shore", "Marblehead Maids is a locally owned cleaning company based in Marblehead"),
    ("Marblehead Maids is a locally owned and operated cleaning company based in Marblehead, Massachusetts", "Marblehead Maids is a locally owned and operated cleaning company based in Marblehead, Massachusetts"),
    ("Marblehead Maids serves homes and businesses across North Shore, MA and the surrounding Essex County communities", "Marblehead Maids serves homes and businesses across the North Shore, North Suburbs, and greater Essex County"),
    ("Marblehead Maids is ready when you are", "Marblehead Maids is ready when you are"),
    ("from Marblehead Maids", "from Marblehead Maids"),
    ("Marblehead Maids did an incredible job", "Marblehead Maids did an incredible job"),
    ("Marblehead Maids — the North Shore's Largest Suburb", "Marblehead Maids"),
    ("Privacy Policy for Marblehead Maids", "Privacy Policy for Marblehead Maids"),
    ("Terms and Conditions for Marblehead Maids", "Terms and Conditions for Marblehead Maids"),
    ("SMS messages from Marblehead Maids", "SMS messages from Marblehead Maids"),
    ("Marblehead Maids. All rights reserved.", "Marblehead Maids. All rights reserved."),
    ("Marblehead Maids - Service Area", "Marblehead Maids - Service Area"),
    ("Generate internal HTML pages for Marblehead Maids clone.", "Generate internal HTML pages for Marblehead Maids."),
]
